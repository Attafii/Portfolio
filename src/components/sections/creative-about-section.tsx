...
import { MapPin, Calendar, Coffee, Code, Heart, Briefcase, Star, Zap, Award, Target } from "lucide-react";

const skills = [
  { name: "React & Next.js", level: 95, color: "from-blue-400 to-blue-600" },
  { name: "TypeScript", level: 90, color: "from-purple-400 to-purple-600" },
  { name: "Node.js", level: 85, color: "from-green-400 to-green-600" },
  { name: "IoT Development", level: 88, color: "from-orange-400 to-orange-600" },
  { name: "Cloud Architecture", level: 82, color: "from-pink-400 to-pink-600" },
  { name: "PostgreSQL", level: 87, color: "from-indigo-400 to-indigo-600" }
];

const achievements = [
  { icon: Award, title: "Top Performer", desc: "Capgemini Excellence Award 2024", color: "text-yellow-500" },
  { icon: Target, title: "Project Success", desc: "100% client satisfaction rate", color: "text-green-500" },
  { icon: Zap, title: "Innovation", desc: "5+ IoT solutions deployed", color: "text-blue-500" },
  { icon: Star, title: "Recognition", desc: "Featured in tech publications", color: "text-purple-500" }
];
  ...
  return (
    <section ref={containerRef} className="py-32 relative overflow-hidden">
      ...
      <motion.div 
        ...
        style={{ y }}
      >
        <div className="absolute inset-0 bg-gradient-to-br from-purple-400/20 via-pink-400/20 to-blue-400/20" />
        <div 
        ...
        >
          ...
          >
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-full bg-purple-100/50 dark:bg-purple-900/30 border border-purple-200 dark:border-purple-800">
              ...
              <span className="text-sm font-medium text-purple-700 dark:text-purple-300">About Me</span>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 mb-20">
            ...
            >
              {/* Personal Story Card */}
              <Card className="group relative overflow-hidden bg-gradient-to-br from-white/80 to-purple-50/80 dark:from-gray-900/80 dark:to-purple-900/20 border-purple-200/50 dark:border-purple-800/50 backdrop-blur-sm">
                <motion.div
                  className="absolute inset-0 bg-gradient-to-br from-purple-400/10 to-pink-400/10"
                ...
                <CardContent className="relative p-8">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    <p>
                      Born and raised in <strong className="text-purple-600 dark:text-purple-400">Tunisia 🇹🇳</strong>, 
                    ...
                    <p>
                      Currently serving as an <strong className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              ...
              {/* Timeline */}
              <Card className="relative bg-gradient-to-br from-blue-50/80 to-purple-50/80 dark:from-blue-900/20 dark:to-purple-900/20 border-blue-200/50 dark:border-blue-800/50 backdrop-blur-sm">
                    ...
                    {timeline.map((item, index) => (
                      ...
                      >
                        <div className={`w-3 h-3 rounded-full ${
                          item.current ? 'bg-purple-500' : 'bg-gray-400'
            ...
            >
              ...
              <Card className="relative bg-gradient-to-br from-pink-50/80 to-purple-50/80 dark:from-pink-900/20 dark:to-purple-900/20 border-pink-200/50 dark:border-pink-800/50 backdrop-blur-sm">
                <CardContent className="p-8">
                  <h3 className="text-xl font-bold mb-6 bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent">
                    Technical Expertise
                  </h3>
              ...
              {/* Fun Facts */}
              <Card className="relative bg-gradient-to-br from-orange-50/80 to-pink-50/80 dark:from-orange-900/20 dark:to-pink-900/20 border-orange-200/50 dark:border-orange-800/50 backdrop-blur-sm">
                <CardContent className="p-8">
                  <h3 className="text-xl font-bold mb-6 bg-gradient-to-r from-orange-600 to-pink-600 bg-clip-text text-transparent">
                    When I&apos;m Not Coding
                  </h3>
                  <div className="grid grid-cols-2 gap-4">
